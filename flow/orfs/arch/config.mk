# ORFS design config, lane = arch. Copied from ORFS flow/designs/sky130hd/ibex/config.mk
...
export DESIGN_NICKNAME = ibex_top_arch
export DESIGN_NAME = ibex_top
export PLATFORM    = sky130hd
export VERILOG_FILES = $(ARCH_IBEX_ROOT)/flow/out/arch/ibex_top.v
